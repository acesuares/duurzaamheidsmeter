		...
		case "overzicht":
			switch($choice):
				case "totaaloverzicht":
					$site_title = "Resultaten Spiegel 2003: <BR>Totaaloverzicht";
				break;
			endswitch;
		break;
		case "provincie":
			$site_title = "Resultaten Spiegel 2003: <BR>Provincie $provincie";
		break;
		case "gemeente":
			$site_title = "Resultaten Spiegel 2003: <BR>Gemeente $gemeente";
		break;
		case "indicator":
			$site_title = "Resultaten Spiegel 2003: <BR>Indicator: ".strtolower($indicator);
		break;
	endswitch;
